...
restaurant =  Restaurant("Cool Name", "Strange Cousine")
restaurant.describe_restaurant()
restaurant.open_restaurant()
restaurant =  Restaurant("Cooler Name", "Stranger Cousine")
restaurant.describe_restaurant()
restaurant.open_restaurant()
restaurant =  Restaurant("The Coolest Name", "Strangest Cousine")
restaurant.describe_restaurant()
restaurant.open_restaurant()
